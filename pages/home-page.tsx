...
import { ArrowRight, Code, Cpu, Globe, Mail, Github } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center md:text-left grid md:grid-cols-2 items-center gap-12">
          <div className="space-y-8">
            ...
            <motion.p 
              ...
              className="text-lg md:text-xl text-blue-50/90 leading-relaxed max-w-2xl"
            >
            ...
            >
              <a 
                ...
                className="bg-green-600 text-white px-8 py-4 rounded-full font-bold shadow-xl hover:bg-green-700 transition-all text-center flex items-center justify-center gap-2"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-green-500 text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-green-400 transition-all shadow-xl shadow-green-500/20"
            >
              Message me on WhatsApp
            </a>
            <a 
              href="mailto:sphynick@gmail.com" 
              className="bg-white/10 border border-white/20 text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-white/20 transition-all"
            >
              Email Me
            </a>
